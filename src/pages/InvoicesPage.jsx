...
import { formatDate, formatServiceType, getDateRange, getFilterLabel } from '../utils/helperFunctions.jsx';
...
const InvoicesPage = () => {
    ...
    const mapServeToTableRow = (invoice) => ({
        ...
        title: invoice.title,
        service_type: formatServiceType(invoice.service_type) || 'N/A',
            ...
            <DashboardContainer>
                <MainContent>
                    <CustomDataTable 
                        ...
                        title="All Invoices"
                        subtitle={`${getFilterLabel(IntervalFilters, timeFilter)} invoices generated by ${user?.type === 'firm' ? 'firm' : 'individual'}`}
                        columns={columns}
                        ...
                        loading={loading}
                        error={error}
                        onRowClick={(rowData) => navigation.navigateToInvoiceDetails(rowData)}
